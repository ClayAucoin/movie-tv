...
LOCK_FILE = "lock-importfeaturettesmetadata.lock"
...
try:
    ...
    if platform.system() == "Windows":
        OUTPUT_CSV = (
            r"E:/My Drive/__clay0aucoin@gmail.com/movies_on_m/featurettes_on_m.csv"
        )
        ...
        OUTPUT_CSV = r"/mnt/c/Users/Administrator/Dropbox/featurettes_on_m"
    ...
    try:
        ...
        log(msg)
        notify("Featurettes Metadata Script", msg)
        raise
    ...
    log("✅ " + summary)
    notify(
        "Featurettes Metadata Script", f"✅ Script completed successfully.\n\n{summary}"
    )
