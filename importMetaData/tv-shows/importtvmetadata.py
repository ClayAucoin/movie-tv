"""
python "C:/Users/Administrator/projects/movie-tv/importMetaData/tv-shows/importtvmetadata.py"
python
...
UNC_ROOT = r"\\192.168.1.205\Media\TV Shows"
M_ROOT = r"M:\TV Shows"
...
LOCK_FILE = "lock-importtvmetadata.lock"
...
try:
    ...
    if platform.system() == "Windows":
        OUTPUT_CSV = r"G:/My Drive/__clay0aucoin@gmail.com/movies_on_m/tvshows_on_m.csv"
    ...
    try:
        ...
        log(msg)
        notify("TV Show Metadata Script", msg)
        raise
    ...
    log("✅ " + summary)
    notify("TV Show Metadata Script", f"✅ Script completed successfully.\n\n{summary}")
